...
#import dillds(dill.dumps(weakref.proxy(_class())))
...
modelGA.summary()
#historyNN = modelGA.fit(x_train, y_train, batch_size=50, epochs=20, validation_split = 0.2)
